...
set VAR_4=--material-name P430_IVR --manufacturing-lot 1337 --manufacturing-date "2017-02-01 01:01:02" --use-date "2017-02-01 01:01:02" --initial-material 43.0 --current-material 43.0 --key-fragment 55aa55c395bf4ebe --version 1 --signature STRATASYS -o new.bin
set HX_0=%3
set HX_1=%4
set HX_2=%5
set HX_3=%6
